    ...
    <Container>
      ...
      <RadioForm>
        <InputContainer>
          ...
          ></RadioInput>
          <RadioLabel for="bca">
            <RadioLabelImage src={bca}></RadioLabelImage>
          </RadioLabel>
        </InputContainer>
        <InputContainer>
          <RadioInput
            ...
            value="mandiri"
          ></RadioInput>
          <RadioLabel for="mandiri">
            <RadioLabelImage src={mandiri}></RadioLabelImage>
          </RadioLabel>
        </InputContainer>
        <InputContainer>
          <RadioInput
          ...
          ></RadioInput>
          <RadioLabel for="bri">
            <RadioLabelImage src={bri}></RadioLabelImage>
          </RadioLabel>
        </InputContainer>
        <InputContainer>
          <RadioInput
          ...
          ></RadioInput>
          <RadioLabel for="bni">
            <RadioLabelImage src={bni}></RadioLabelImage>
          </RadioLabel>
        </InputContainer>
        <InputContainer>
          <RadioInput
          ...
          ></RadioInput>
          <RadioLabel for="ovo">
            <RadioLabelImage src={ovo}></RadioLabelImage>
          </RadioLabel>
        </InputContainer>
        <InputContainer>
          <RadioInput
            ...
            value="gopay"
          ></RadioInput>
          <RadioLabel for="gopay">
            <RadioLabelImage src={gopay}></RadioLabelImage>
          </RadioLabel>
        </InputContainer>
        <InputContainer>
          <RadioInput
            ...
            value="shopeepay"
          ></RadioInput>
          <RadioLabel for="shopeepay">
            <RadioLabelImage src={shopeepay}></RadioLabelImage>
          </RadioLabel>
        </InputContainer>
        <InputContainer>
          <RadioInput
          ...
          ></RadioInput>
          <RadioLabel for="dana">
            <RadioLabelImage src={dana}></RadioLabelImage>
          </RadioLabel>
        </InputContainer>
      </RadioForm>
      <Line></Line>
      <PaymentStatus>
        ...
        <PaymentStatusInfo>
          <TextH2 className="total">
            Total: Rp. {total + total / 10 + 15000},-
          </TextH2>
          <BtnV2
            onClick={(e) => {
              if (
            ...
            onChange={(e) => {
              ...
              if (persen !== 0) {
                document.querySelector(
                  '.status'
                ).innerHTML = `Discount ${persen}%`;
                document.querySelector(
                  '.total'
                ).innerHTML = `Total: Rp. ${cekTotal(persen)},-`;
              } else {
                document.querySelector('.status').innerHTML = 'Not Available';
                document.querySelector('.total').innerHTML = `Total: Rp. ${
                  total + total / 10 + 15000
                },-`;
              }
            }}
          ></VoucherInput>
      ...
      <PopupContainer to="/" className="popup">
        <PopupItem>
          ...
          <PopupText>
            ...
            <TextPBlack>
              thank you for order at pizzaria. we are processing your order,
              please wait a moment and if there are problems please contact us
