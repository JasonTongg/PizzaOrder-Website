...
import {BodyContainer, BodyHeader, TableHeader, HeaderItem, TableItemContainer, HeaderItems} from './HistoryElements';
  ...
  return (
    <BodyContainer>
      ...
      <TableItemContainer>
        ...
        {Array.from(products).reverse().map((product, index) => (
          <TableHeader>
